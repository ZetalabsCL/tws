    function Validar(){
        ...
        if(!document.contactform.name.value || document.contactform.name.value == null){
            ...
            vjs("#contactform #name").parent().append("<label for='contactname' generated='true' class='error'>Please enter your Name</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #company").parent().append("<label for='contactname' generated='true' class='error'>Please enter a company</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #id").parent().append("<label for='contactname' generated='true' class='error'>Please enter an ID</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #idcom").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Company ID</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #cargo").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Position</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #fax").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Fax</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #email").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Valid Email</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #pais").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Country</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #telefono").parent().append("<label for='contactname' generated='true' class='error'>Please enter a Phone Number</label>");
            ...
            vjs('#contactform #telefono').parent().find(".error").remove();
            vjs('#contactform #ciudad').parent().find(".error").remove();
            vjs("#contactform #ciudad").parent().append("<label for='contactname' generated='true' class='error'>Please enter a City</label>");
